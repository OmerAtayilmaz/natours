...
var showAlert = function showAlert(type, msg) {
  hideAlert(); //type:success or error
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoib21lcmF0YXlpbG1heiIsImEiOiJja3psOGNhNzcyY2ppMnVvY3Rnd2M4bmR0In0.jNFBu76Zf600ep7tv_Vd2w";
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: "bottom"
    }).setLngLat(loc.coordinates).addTo(map); //Add popup marker

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ":").concat(loc.description, "</p>")).addTo(map); //Extends the map bounds to current location
...
/* eslint-disable */
var stripe = Stripe("pk_test_51JKIAWG6RJPkyqnOaXtgS8WmVqCiXMK4LX4qiV8VD6CygbMR3qaeQcwuVJxT0AeOhVCJpGgbzQENHfz8GSfHrE0S00Kzs8vPFc");
...
var userPassForm = document.querySelector(".form-user-password");
...
if (signupForm) {
  document.querySelector("#signupForm").addEventListener("submit", function (e) {
    ...
    e.preventDefault();
    var signupemail = (_document$querySelect = document.querySelector("#signupemail")) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.value;
    var signuppassword = (_document$querySelect2 = document.querySelector("#signuppassword")) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.value;
    var signupname = (_document$querySelect3 = document.querySelector("#signupname")) === null || _document$querySelect3 === void 0 ? void 0 : _document$querySelect3.value;
    (0, _signup.signup)({
      email: signupemail,
...
if (userPassForm) {
  userPassForm.addEventListener("submit", /*#__PURE__*/function () {
